...
La aplicación inicia con una splash screen que muestra el logo de la aplicación y el nombre, luego de esto entra a la pantalla de Log in, en la cuál se le pide al usuario el nombre y clave de su cuenta, en caso de no contar con una se les presenta la opción de crear una, una vez logra ingresar entra a la pantalla de Home, en esta se muestran 3 opciones Inventario, Lista de compra y lugares de interés. En la pantalla de inventario se muestran los objetos que tiene actualmente el usuario en su despensa, en la lista de compra puede añadir más productos a su inventario, a la vez que le indica el dinero que va a gastar, en la pantalla de lugares se muestran sitios en los cuales puede ir a comprar en físico, un pequeño detalle y su dirección.